            ...
            <div className=' flex flex-col items-center sm:w-[380px] w-[1000px]  pt-8 h-[830px] bg-white shadow-xl shadow-gray-400 rounded-b-xl'>
                ...
                <form className='w-[700px]'>
                    ...
                    <div className='flex gap-6 mt-2 w-full'>
                        ...
                        <div className='flex flex-col gap-2 w-1/2'>
                            <div className='flex'>
                                <label className='text-md text-indigo-900'>Brand Type</label>
                                {/* Tooltip */}
                            ...
                            <input className='outline-none rounded-md border border-gray-300 focus:border-sky-300 p-2' type='text' name='brandType' value={formData.brandType} onChange={handleChange} placeholder='Input Brand Type' required />
                        </div>
                    </div>
                ...
                <div className='w-[700px]'>
                    ...
                    <p className='mt-2 text-indigo-900'>Once the following documents are signed, you'll be ready to get started </p>
                    <div className='flex mt-1  gap-5'>
                        <p className='relative border text-indigo-900 border-gray-300 pb-2 pt-2 pl-4 pr-4 rounded-md w-full ' onClick={() => toggleSigned('coi')}>Electronically sign the agreements <span className='cursor-pointer absolute right-0 pr-2'> {isSigned.coi ? <i className='bx bx-check bx-sm align-middle' style={{ color: '#00ff2c' }} ></i> : <i className='bx bx-x bx-sm align-middle' style={{ color: '#ff0000' }}  ></i>}</span></p> <span className="border border-indigo-400 bg-indigo-400 text-white p-2 pl-3 pr-3 rounded-md"><i className='bx bx-chevron-right align-middle'></i></span>
                    </div>
